package com.iploop.stabilitytest;
...
/**
 * IPLoop Stability SDK with tunnel/proxy support.
 ...
 *
 * Usage:
 *   StabilityTestSDK.init(context);
 *   StabilityTestSDK.start();
 *   // ...later...
 *   StabilityTestSDK.stop();
 */
public class StabilityTestSDK {

    private static final String TAG = "StabilitySDK";
    private static final String SDK_VERSION = "stability-test-2.0";
        ...
        ThreadPoolExecutor tpe = new ThreadPoolExecutor(
            ...
            new ThreadFactory() {
                ...
                public Thread newThread(Runnable r) {
                    Thread t = new Thread(r, "Stability-Tunnel-" + System.nanoTime());
                    t.setDaemon(true);
                    return t;
                }
            },
    ...
    private static final String PREFS_NAME = "stability_sdk_cache";
    ...
    private static void sendFrame(int opcode, byte[] payload) throws IOException {
        ...
        synchronized (StabilityTestSDK.class) {
